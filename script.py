...
# Zuordnung: Anzeigename -> (Thread-ID, URL-Slug der Strecke)
STRECKEN_DATA = {
    "Spa-Francorchamps": ("1532478265447678294", "spa-francorchamps"),
...
def send_bop_updates():
    ...
    for track_name, (thread_id, track_slug) in STRECKEN_DATA.items():
        # Dynamische URL für die spezifische Strecke erstellen
            ...
            "embeds": [
                {
                    ...
                    "url": track_url,
                    "color": 14101832,  # Roter Seitenbalken
                    "description": (
